...
class HammingMarker(object):
    ...
    def highlite_marker(self, img, contour_color=(0, 255, 0), text_color=(255, 0, 0), linewidth=5, text_thickness=1, text = str(id)):
        """
        ...
        for i, line in enumerate(text.split('\n')):
            ...
            cv2.putText(img, line, (self.center[0] - 50, y), cv2.FONT_HERSHEY_SIMPLEX, text_thickness, text_color)
        return img
